...
class __TwigTemplate_fddb194e08f8023ddb4c8ff2e3a4449ead37e26212f5b8de1bea81470a63a73f extends Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"container-fluid\">
    <div class=\"card\">
      ...
      <div class=\"card-body\">
        ...
        echo "</label>
            <div class=\"col-sm-10\">
              <input type=\"text\" name=\"total_handling_total\" value=\"";
        // line 24
        echo ($context["total_handling_total"] ?? null);
        echo "\" placeholder=\"";
        echo ($context["entry_total"] ?? null);
        ...
        echo "</label>
            <div class=\"col-sm-10\">
              <input type=\"text\" name=\"total_handling_fee\" value=\"";
        // line 31
        echo ($context["total_handling_fee"] ?? null);
        echo "\" placeholder=\"";
        echo ($context["entry_fee"] ?? null);
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["tax_class"]) {
            ...
            echo "\"";
            if ((twig_get_attribute($this->env, $this->source, $context["tax_class"], "tax_class_id", [], "any", false, false, false, 40) == ($context["total_handling_tax_class_id"] ?? null))) {
        ...
        echo "</label>
            <div class=\"col-sm-10\">
              <div class=\"form-check form-switch form-switch-lg\">
                ...
                <input type=\"checkbox\" name=\"total_handling_status\" value=\"1\" id=\"input-status\" class=\"form-check-input\"";
        // line 50
        if (($context["total_handling_status"] ?? null)) {
            echo " checked";
        }
        echo "/>
              </div>
        ...
        echo "</label>
            <div class=\"col-sm-10\">
              <input type=\"text\" name=\"total_handling_sort_order\" value=\"";
        // line 57
        echo ($context["total_handling_sort_order"] ?? null);
        echo "\" placeholder=\"";
        echo ($context["entry_sort_order"] ?? null);
...
";
    ...
    {
        return "extension/opencart/admin/view/template/total/handling.twig";
    }
    ...
    {
        return new Source("", "extension/opencart/admin/view/template/total/handling.twig", "C:\\xampp\\htdocs\\opencart\\extension\\opencart\\admin\\view\\template\\total\\handling.twig");
    }
}
